...
{
    public partial class InventoryDeliveryDutyAfternoonForm : Form
    {
        ...
        public InventoryDeliveryDutyAfternoonForm()
        {
            InitializeComponent();
        }

        private void InventoryDeliveryDutyAfternoonForm_Load(object sender, EventArgs e)
        {
